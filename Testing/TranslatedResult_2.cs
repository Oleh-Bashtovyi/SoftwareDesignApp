...
namespace GeneratedMultithreadedProgram
{
    class Program
    {
        ...
        private static void Diagram_1()
        {
            ...
            {
                Console.WriteLine($"Error in Diagram_3: {ex.Message}");
            }
        }

        private static void Diagram_2()
        {
            try
            {
                lock (_syncLock)
                {
                        ...
                        goto Block_4;
                        Block_4:
                        Console.WriteLine("_777_ = " + _777_);
                        goto End;
                }
            }
            catch (Exception ex)
            {
                Console.WriteLine($"Error in Diagram_4: {ex.Message}");
            }
        }
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("Starting Diagram_2...");
                var task2 = Task.Run(() => Diagram_2());
                tasks.Add(task2);
